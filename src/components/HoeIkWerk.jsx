...
const STEPS = [
  ...
  },
  {
    ...
    text: 'Once your site is live, updates are handled by my AI agent — not me personally. You WhatsApp it like you would a real person. It responds in my style, processes the change, and puts it live within minutes. All included in your monthly plan.',
    color: '#22C55E',
  ...
  },
  {
    ...
    text: 'Hosting, uptime monitoring, security updates, and AI-powered content changes — all in one fixed monthly amount. No surprises, no extra invoices. You focus on your work. The rest runs itself.',
    color: '#F59E0B',
